...
use App\Repository\ProcessingSpecificationsRepository;
use Doctrine\ORM\Mapping as ORM;

/**
 * @ORM\Entity(repositoryClass=ProcessingSpecificationsRepository::class)
 */
class ProcessingSpecifications
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Coleccion::class, inversedBy="ProcessingSpecifications")
     */
    private $coleccion;
